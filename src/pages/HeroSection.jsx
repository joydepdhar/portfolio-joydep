...
// {/* Highlights */}
// <ul className="list-disc list-inside text-gray-400 text-sm sm:text-base space-y-2 mt-4 max-w-md mx-auto md:mx-0 text-left">
//   <li>🔒 Built enterprise-grade secure backend infrastructures</li>
//   <li>⚡ Delivered responsive & scalable web applications</li>
//   <li>📊 Automated complex business workflows with Odoo ERP</li>
//   <li>🌍 Open to Freelance, Contract & Remote Opportunities</li>
// </ul>
...
// //             From <span className="text-cyan-400 font-medium">Odoo ERP automation</span>
// //             to <span className="text-cyan-400 font-medium">full-stack web apps</span>,
...
// //               className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-cyan-400 text-cyan-300 hover:bg-cyan-400 hover:text-[#0F172A] text-sm font-semibold transition-transform duration-300 hover:scale-105"
// //               aria-label="Visit Joydep Dhar's LinkedIn"
// //             >
...
// //               rel="noopener noreferrer"
// //               className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-cyan-400 text-cyan-300 hover:bg-cyan-400 hover:text-[#0F172A] text-sm font-semibold transition-transform duration-300 hover:scale-105"
// //               aria-label="Visit Joydep Dhar's GitHub"
// //             >
